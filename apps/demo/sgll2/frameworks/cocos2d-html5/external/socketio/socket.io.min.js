...
(function() {
    (function(a, b) {
        ...
        (c.version = '0.9.16'),
            ...
            (c.connect = function(a, d) {
                ...
                b &&
                    b.location &&
                    ((e.protocol =
                        e.protocol || b.location.protocol.slice(0, -1)),
                    (e.host =
                        e.host ||
                        (b.document ? b.document.domain : b.location.hostname)),
        ...
        (function(a, b) {
            ...
            (c.load = function(a) {
                if (
                    ('document' in b && document.readyState === 'complete') ||
                    f
                )
                    return a();
                c.on(b, 'load', a, !1);
        ...
        (function(a, b, c) {
            ...
            (a.Socket = d),
                ...
                (d.prototype.of = function(a) {
                    return (
                        this.namespaces[a] ||
                            ((this.namespaces[a] = new b.SocketNamespace(
                                this,
                                a
                            )),
                            a !== '' &&
                                this.namespaces[a].packet({ type: 'connect' })),
                        this.namespaces[a]
                    );
                }),
                ...
                (d.prototype.getTransport = function(a) {
                    ...
                    for (var e = 0, f; (f = c[e]); e++)
                        if (
                            ...
                            (!this.isXDomain() ||
                                b.Transport[f].xdomainCheck(this))
                        )
                    ...
                    return (
                        ...
                        this.handshake(function(d, e, f, g) {
                                ...
                                c.transport.ready(c, function() {
                                    (c.connecting = !0),
                                        ...
                                        c.options['connect timeout'] &&
                                            (c.connectTimeoutTimer = setTimeout(
                                                function() {
                                                    if (!c.connected) {
                                                        c.connecting = !1;
                                                        if (
                            ...
                            (c.sessionid = d),
                                ...
                                c.transports ||
                                    (c.transports = c.origTransports = g
                                        ? b.util.intersect(
                                              g.split(','),
                ...
                (d.prototype.isXDomain = function() {
                    var a =
                        c.location.port ||
                        ('https:' == c.location.protocol ? 443 : 80);
                    return (
                        this.options.host !== c.location.hostname ||
                        this.options.port != a
                    );
                }),
                        ...
                        if (a.connected) {
                            for (var b in a.namespaces)
                                a.namespaces.hasOwnProperty(b) &&
                                    '' !== b &&
                                    a.namespaces[b].packet({ type: 'connect' });
                            a.publish(
                                'reconnect',
                                a.transport.name,
                    ...
                    switch (a.type) {
                        ...
                        case 'json':
                            ...
                            a.ack == 'data'
                                ? e.push(d)
                                : a.ack &&
                                  this.packet({ type: 'ack', ackId: a.id }),
    ...
    if ('undefined' != typeof window)
        var swfobject = (function() {
                            ...
                            if (g)
                                if (S(m[c].swfVersion) && !(y.wk && y.wk < 312))
                                    ...
                                    (h.data = m[c].expressInstall),
                                        (h.width =
                                            g.getAttribute('width') || '0'),
                                        (h.height =
                                            g.getAttribute('height') || '0'),
                                        g.getAttribute('class') &&
                                            (h.styleclass = g.getAttribute(
                                                'class'
                                            )),
            ...
            function V(b) {
                var c = /[\\\"<>\.;]/,
                    d = c.exec(b) != null;
                return d && typeof encodeURIComponent != a
            ...
            var a = 'undefined',
                ...
                y = (function() {
                    ...
                    if (typeof j.plugins != a && typeof j.plugins[c] == b)
                        ...
                        typeof h[['Active'].concat('Object').join('X')] != a
                    )
                        try {
                            var s = new window[
                                ['Active'].concat('Object').join('X')
    ...
    (function() {
        ...
        location.protocol == 'file:' &&
            ...
            (WebSocket.__isFlashLite = function() {
                ...
                return !a || !a.enabledPlugin || !a.enabledPlugin.filename
                    ? !1
        ...
        (function(a, b, c) {
            ...
            (a['xhr-polling'] = d),
                ...
                (d.prototype.get = function() {
                    ...
                    function f() {
                        a.retryCounter++,
                            !a.retryCounter || a.retryCounter > 3
                                ? a.onClose()
                                : a.get();
                    }
