...
var AutoJoypad = cc.Layer.extend({
    _winSize: null,
    _pCenter: null,
    ...
    init: function(model) {
        ...
        if (this._super()) {
            ...
            // cc.log("Joypad init ..");
            // 控制杆所在位置
            this._pDefaultPoint = cc.p(-1100, 110);
            // 默认旋转角度，以使开口正对右侧
    ...
    updateRotation: function() {
        ...
        if (this._model) {
            ...
            this._gestureLastAngle = angle;
            // this._model.getView().getEquipLayer().setRotation(angle);
            ...
            if (1 == 1) {
                if (this._heroMoveDone) {
                    ...
                    this._model
                        .getView()
                        .oneStepAction(
                            me._gestureLastAngle,
                            me._heroStepDistance,
                            function() {
