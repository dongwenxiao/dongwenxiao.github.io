        ...
        function(window) {
                    ...
                    var g = {
                        ...
                        findIndex: function(h, i) {
                            ...
                            var j = Object(this),
                                k = j.length >>> 0;
                            for (var l = 0; l < k; l++)
                                if (l in j) if (h.call(i, j[l], l, j)) return l;
                            return -1;
                        }
                    };
                    e.exports = g;
                ...
                function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    function w(x, y, z) {
                        var aa = Array.prototype.slice.call(arguments, 3),
                            ba = z ? r.call(x).slice(8, -1) + '.prototype' : x,
                            ca = s[ba + '.' + y] || x[y];
            ...
            __d(
                ...
                function(a, b, c, d, e, f, g) {
                    ...
                    function k(l, m, n) {
                        var o =
                            m && m.hasOwnProperty('constructor')
                                ? m.constructor
                                : function() {
                        ...
                        o.parent = l;
                        o.prototype.__mixins = l.prototype.__mixins
                            ? Array.prototype.slice.call(l.prototype.__mixins)
                            : [];
                        if (n) j(o, n);
            ...
            __d(
                ...
                function(a, b, c, d, e, f, g, h) {
                    ...
                    (function() {
                        var k = /app_runner/.test(window.name)
                            ? i.PAGETAB
            ...
            __d(
                'sdk.createIframe',
                ['guid', 'hasNamePropertyBug', 'DOMEventListener'],
            ...
            __d(
                'sdk.getContextType',
                ['UserAgent_DEPRECATED', 'sdk.Runtime'],
                function(a, b, c, d, e, f, g, h) {
                    function i() {
            ...
            __d(
                'sdk.Content',
                ['sdk.domReady', 'Log', 'UserAgent_DEPRECATED'],
                function(a, b, c, d, e, f, g, h, i) {
                    var j,
                        k,
                        l = {
                ...
                function(a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function n(p, q, r, s) {
                        ...
                        if (q instanceof o) {
                            ...
                            p.setForceFragmentSeparator(
                                q.getForceFragmentSeparator()
                            );
                            return true;
                        }
                    ...
                    o.prototype.isEmpty = function() {
                        ...
                        return !(
                            ...
                            this.getDomain() ||
                            this.getPort() ||
                            ES('Object', 'keys', false, this.getQueryData())
                                .length > 0 ||
                            this.getFragment()
                        );
                    };
            ...
            __d(
                ...
                function(a, b, c, d, e, f, g) {
                    ...
                    h.prototype.stub = function(i) {
                        ...
                        this.remote[i] = ES(
                            function() {
                                var j = Array.prototype.slice.call(
                                        arguments,
                                        0
                                    ),
                                    k = { jsonrpc: '2.0', method: i };
            ...
            __d(
                ...
                function(a, b, c, d, e, f) {
                    ...
                    function i(j) {
                        ...
                        return (
                            ES(h, 'indexOf', true, j.getProtocol()) !== -1 &&
                            g.test(j.getDomain())
                        );
                    }
                    e.exports = i;
                ...
                function(
                    ...
                    var sa = {
                        ...
                        handler: function(ta, ua, va, wa) {
                            ...
                            return (
                                (location.protocol == 'https:' ? fa : ea) + xa
                            );
                        },
                ...
                function(
                    ...
                    function aa(da) {
                        ...
                        var ga = z(da, u, 'login_status'),
                            ha = s(
                                r.resolve('www', true) + '/connect/ping'
                            ).setQueryData({
            ...
            __d(
                ...
                function(
                    ...
                    r.setSecure(
                        (function() {
                            var ca = /iframe_canvas|app_runner/.test(
                                    window.name
                                ),
            ...
            __d(
                ...
                function(
                    ...
                    function fa(la) {
                        ...
                        h.isTrue(
                            w.hasOwnProperty(qa),
                            o('Invalid method passed to ApiClient: %s', qa)
                        );
                        var ra = oa['function'];
                    ...
                    function ga() {
                        var la = Array.prototype.slice.call(arguments, 0),
                            ...
                            qa = pa.method,
                            ra =
                                na.getProtocol() && na.getDomain()
                                    ? na.setQueryData({}).toString()
                                    : q.resolve('graph') + na.getPath();
                        da(
                            ra,
                            qa == 'get' ? 'get' : 'post',
                            pa,
                            ES(ea, 'bind', true, null, oa, na.getPath(), qa, pa)
                        );
                    }
                    function ha() {
                        var la = Array.prototype.slice.call(arguments, 0),
            ...
            __d(
                'sdk.AppEvents',
                ['Assert', 'sdk.Impressions', 'merge', 'sdk.Runtime'],
                function(a, b, c, d, e, f, g, h, i, j) {
                    var k = {
            ...
            __d(
                'legacy:fb.appevents',
                ['Assert', 'sdk.AppEvents', 'FB', 'sdk.feature', 'sdk.Runtime'],
                function(a, b, c, d, e, f, g, h, i, j, k) {
                    i.provide('AppEvents', {
                        logEvent: function(l, m, n) {
                            g.isTrue(
                                j('allow_non_canvas_app_events') ||
                                    k.isCanvasEnvironment(),
                ...
                function(
                    ...
                    var ba = {
                            transform: function(ea) {
                                if (
                                    ea.params.display === 'touch' &&
                                    ea.params.access_token &&
                                    window.postMessage
                                ) {
                                    ea.params.channel = da._xdChannelHandler(
                                        ea.id,
                                        'parent'
                                    );
                        ...
                        ca = {
                            ...
                            apprequests: {
                                transform: function(ea) {
                                    ea = ba.transform(ea);
                                    ea.params.frictionless =
                                        n && n._useFrictionless;
                                    if (ea.params.frictionless) {
                                        ...
                                        ea.cb = n._processRequestResponse(
                                            ea.cb,
                                            ea.hideLoader
                                        );
                                    }
                                ...
                                transform: function(ea) {
                                    ...
                                    var ha = ES(
                                        ...
                                        ES(
                                            ...
                                            'assign',
                                            false,
                                            ea.params.response_type
                                                ? i(
                                                      ea.params.response_type.split(
                                                          ','
                                                      )
                                                  )
                                                : {},
                        ...
                        da = {
                            ...
                            checkOauthDisplay: function(ea) {
                                ...
                                for (var ha = 0; ha < ga.length; ha++)
                                    if (
                                        !x.initSitevars.iframePermissions[
                                            ES(ga[ha], 'trim', true)
                                        ]
                                    )
                                        return 'popup';
                            ...
                            prepareCall: function(ea, fa) {
                                var ga = ea.method.toLowerCase(),
                                    ha = da.Methods.hasOwnProperty(ga)
                                        ? ES(
                                              'Object',
                                              'assign',
                                              false,
                                ...
                                if (
                                    ...
                                    (ea.display == 'iframe' ||
                                        (ea.display == 'touch' && ea.in_iframe))
                                )
                                    ea.display = da.checkOauthDisplay(ea);
                                if (
                                    w.getIsVersioned() &&
                                    ha.url.substring(0, 7) === 'dialog/'
                                )
                                ...
                                var ma = ha.getXdRelation || da.getXdRelation,
                                    na = ma(ka.params);
                                if (
                                    !(ka.id in da._defaultCb) &&
                                    !('next' in ka.params) &&
                                    !('redirect_uri' in ka.params)
                                )
                                    ka.params.next = da._xdResult(
                                        ka.cb,
                                        ka.id,
                                        na,
                                        true
                                ...
                                if (na === 'parent')
                                    ES(
                                        ...
                                        ka.params,
                                        {
                                            channel_url: da._xdChannelHandler(
                                                ia,
                                                'parent.parent'
                                            )
                                        },
                            ...
                            getDisplayMode: function(ea, fa) {
                                if (
                                    ...
                                    return fa.display;
                                var ga =
                                    w.isEnvironment(w.ENVIRONMENTS.CANVAS) ||
                                    w.isEnvironment(w.ENVIRONMENTS.PAGETAB);
                            ...
                            popup: function(ea) {
                                ...
                                if (
                                    ea.name == 'permissions.request' ||
                                    ea.name == 'permissions.oauth'
                                )
                            ...
                            _popupMonitor: function() {
                                ...
                                for (var fa in da._loadedNodes)
                                    if (
                                        da._loadedNodes.hasOwnProperty(fa) &&
                                        fa in da._defaultCb
                                    ) {
                            ...
                            _xdRecv: function(ea, fa) {
                                ...
                                if (ga)
                                    if (ga.close) {
                                        ...
                                        k.containsCss(ga, 'FB_UI_Hidden')
                                    ) {
                                        setTimeout(function() {
                                            ga.parentNode.parentNode.removeChild(
                                                ga.parentNode
                                            );
                                        }, 3000);
                                    } else if (
                                        k.containsCss(ga, 'FB_UI_Dialog')
                                    )
                                        j.remove(ga);
                            ...
                            _xdResult: function(ea, fa, ga, ha) {
                                return (
                                    ...
                                    '&result=' +
                                    encodeURIComponent(da._resultToken)
                                );
                            },
                            xdHandler: function(ea, fa, ga, ha, ia) {
                                return da._xdNextHandler(
                                    g.xdResponseWrapper(ea, ha, ia),
                                    fa,
                                    ga,
                                    true
                                );
            ...
            __d(
                ...
                function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    function n(o, p) {
                        ...
                        if (
                            (q == 'permissions.request' ||
                                q == 'permissions.oauth') &&
                            (o.display == 'iframe' || o.display == 'dialog')
                        )
            ...
            __d(
                ...
                function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    g.subscribe(
                        'logout',
                        ES(j.fire, 'bind', true, j, 'auth.logout')
                    );
                    g.subscribe(
                        'login',
                        ES(j.fire, 'bind', true, j, 'auth.login')
                    );
                    g.subscribe(
                        'authresponse.change',
                ...
                function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    function q() {
                        ...
                        if (
                            Math.random() > 1 / l ||
                            m == '*' ||
                            ~ES(m, 'indexOf', true, j.getClientID())
                        )
                            return;
                        setTimeout(p, 30000);
                    }
                        ...
                        pay: {
                            ...
                            transform: function(n) {
                                if (k('launch_payment_dialog_via_pac')) {
                                    ...
                                    n.cb = m(n.cb);
                                    if (
                                        !h.isEnvironment(h.ENVIRONMENTS.CANVAS)
                                    ) {
                                        n.params.order_info = ES(
                                            'JSON',
                                            'stringify',
                                            false,
                                            n.params.order_info
            ...
            __d(
                ...
                function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    function u(ba) {
                        return ba.scopeName
                            ? ba.scopeName + ':' + ba.nodeName
                            : '';
                    }
                    function v(ba) {
                        return (
                            p[t(ba, 'nodeName').toLowerCase()] ||
                            p[u(ba).toLowerCase()]
                        );
                    }
                    function w(ba) {
                        var ca = ES(
                            ES(t(ba, 'className'), 'trim', true).split(/\s+/),
                            'filter',
                            true,
                            function(da) {
                        ...
                        if (
                            ba.getAttribute('fb-xfbml-state') ||
                            !ba.childNodes ||
                            ba.childNodes.length === 0 ||
                            (ba.childNodes.length === 1 &&
                                ba.childNodes[0].nodeType === 3) ||
                            (ba.children.length === 1 &&
                                t(ba.children[0], 'className') ===
                    ...
                    function z(ba, ca, da) {
                        ...
                        ES(
                            ...
                            function(ja) {
                                ...
                                var ma = function() {
                                    if (
                                        ja.getAttribute('fb-xfbml-state') ==
                                        'parsed'
                                    ) {
            ...
            __d(
                ...
                function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    function u() {
                        return !!(
                            h('plugin_pipe') &&
                            n.getSecure() !== undefined &&
                            (p.chrome() || p.firefox()) &&
                            m.enabledApps[n.getClientID()]
                        );
                    }
                    function v() {
                        var x = t;
                    ...
                    function w(x) {
                        ...
                        var aa = ES('JSON', 'stringify', false, z),
                            ba = k.encode(aa);
                        ES(x, 'forEach', true, function(ea) {
                            var fa = document.getElementsByName(
                                ea.config.name
                            )[0];
                ...
                function(
                    ...
                    var t = l.extend({
                            ...
                            _updateIframeZIndex: function() {
                                var x = this.dom.getElementsByTagName(
                                        'span'
                                    )[0],
                                    y = this.getIframeNode(),
                                    z =
                                        y.style.height === x.style.height &&
                                        y.style.width === x.style.width,
                ...
                function(a, b, c, d, e, f, g, h, i, j) {
                    var k = i.extend({
                        process: function() {
                            ...
                            g.scheduleBatchCall(
                                '/v2.1/' + encodeURIComponent(l),
                                { fields: 'share' },
                                ES(
                                    function(m) {
                                        var n =
                                            (m.share &&
                                                m.share.comment_count) ||
                                            0;
                                        h.html(
                                            this.dom,
                                            j(
                        ...
                        o = j.extend({
                            process: function() {
                                ES('Object', 'assign', false, this, {
                                    ...
                                    _reflexive: this._getBoolAttribute(
                                        'reflexive'
                                    ),
                                    _objective: this._getBoolAttribute(
                                        'objective'
                                    ),
                                    _linked: this._getBoolAttribute(
                                        'linked',
                                        true
                                    ),
                ...
                function(a, b, c, d, e, f, g, h, i, j, k) {
                    var l = i.extend({
                        ...
                        setupAndValidate: function() {
                            ...
                            this.subscribe(
                                'xd.authLogin',
                                ES(this._onAuthLogin, 'bind', true, this)
                            );
                            this.subscribe(
                                'xd.authLogout',
                                ES(this._onAuthLogout, 'bind', true, this)
                            );
                            return true;
                        },
                        getSize: function() {
            ...
            __d(
                ...
                function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    n.subscribe(
                        'parse',
                        ES(i.fire, 'bind', true, i, 'xfbml.parse')
                    );
                    n.subscribe(
                        'render',
