 ...
 */
    (function(q) {
        ...
        b.fromString = function(a, c, d) {
            ...
            for (var f = b.ZERO, g = 0; g < a.length; g += 8) {
                var k = Math.min(8, a.length - g),
                    m = parseInt(a.substring(g, g + k), d);
                8 > k
                    ? ((k = b.fromNumber(Math.pow(d, k))),
                      (f = f.multiply(k).add(b.fromNumber(m))))
                    : ((f = f.multiply(e)), (f = f.add(b.fromNumber(m))));
            }
            f.unsigned = c;
            return f;
        };
        ...
        b.prototype.getNumBitsAbs = function() {
            if (this.isNegative())
                return this.equals(b.MIN_VALUE)
                    ? 64
                    : this.negate().getNumBitsAbs();
            for (
                var a = 0 != this.high ? this.high : this.low, c = 31;
                0 < c && 0 == (a & (1 << c));
                c--
            );
        ...
        b.prototype.equals = function(a) {
            ...
            return this.unsigned !== a.unsigned &&
                this.high >>> 31 !== a.high >>> 31
                ? !1
            ...
            return b && !d
                ...
                ? a.high >>> 0 > this.high >>> 0 ||
                  (a.high === this.high && a.low >>> 0 > this.low >>> 0)
                    ? -1
                    : 1
                : this.subtract(a).isNegative()
                ? -1
                : 1;
        };
        b.prototype.negate = function() {
            return !this.unsigned && this.equals(b.MIN_VALUE)
                ? b.MIN_VALUE
                : this.not().add(b.ONE);
        };
        ...
        b.prototype.shiftLeft = function(a) {
            ...
            return 0 === (a &= 63)
                ...
                : b.fromBits(0, this.low << (a - 32), this.unsigned);
        };
