...
(function(s) {
    function u(m) {
        ...
        g.TYPES = {
            ...
            uint64: { name: 'uint64', wireType: g.WIRE_TYPES.VARINT },
        ...
        g.Util = (function() {
            ...
            try {
                e.IS_NODE =
                    ...
                    'function' === typeof require('fs').readFileSync &&
                    'function' === typeof require('path').resolve;
            } catch (d) {}
            e.XHR = function() {
                for (
                    var e = [
            ...
            e.fetch = function(d, g) {
                ...
                if (e.IS_NODE)
                    ...
                    'function' === typeof b.overrideMimeType &&
        ...
        g.DotProto = (function(e, d) {
            ...
            n.next = function() {
                ...
                do {
                    for (
                        f = !1;
                        d.WHITESPACE.test((a = this.source.charAt(this.index)));
                ...
                f = this.index;
                d.DELIM.lastIndex = 0;
                if (d.DELIM.test(this.source.charAt(f))) ++f;
                else
                    for (
                        ++f;
                        f < this.source.length &&
                        !d.DELIM.test(this.source.charAt(f));
                ...
                f === d.STRINGOPEN
                    ...
                    : f === d.STRINGOPEN_SQ &&
                      ((this.readingString = !0),
                      (this.stringEndsWith = d.STRINGCLOSE_SQ));
                return f;
            };
            n.peek = function() {
                ...
                for (
                    ...
                    switch (a) {
                        case 'package':
                            if (!c || null !== f['package'])
                                throw Error(
                                    'Unexpected package at line ' + this.tn.line
                                );
                        ...
                        case 'import':
                            if (!c)
                                throw Error(
                                    'Unexpected import at line ' + this.tn.line
                                );
                        ...
                        case 'option':
                            if (!c)
                                throw Error(
                                    'Unexpected option at line ' + this.tn.line
                                );
            ...
            b._parseId = function(f, a) {
                ...
                if (d.NUMBER_DEC.test(f)) c = parseInt(f);
                else if (d.NUMBER_HEX.test(f)) c = parseInt(f.substring(2), 16);
                else if (d.NUMBER_OCT.test(f)) c = parseInt(f.substring(1), 8);
                else
                    throw Error(
                        'Illegal id at line ' +
                            this.tn.line +
            ...
            b._parsePackage = function(f) {
                ...
                if (f != d.END)
                    throw Error(
                        'Illegal end of package at line ' +
                            this.tn.line +
                            ': ' +
                            f
                    );
            ...
            b._parseImport = function(f) {
                ...
                if (f !== d.STRINGOPEN && f !== d.STRINGOPEN_SQ)
                    throw Error(
                        'Illegal start of import at line ' +
                            this.tn.line +
                            ': ' +
                            f
                    );
            ...
            b._parseOption = function(f, a) {
                ...
                if (!d.TYPEREF.test(a) && !/google\.protobuf\./.test(a))
                    throw Error(
                        'Illegal option name in message ' +
                            f.name +
                            ' at line ' +
                            this.tn.line +
                            ': ' +
                ...
                else if (d.BOOL.test(a)) c = 'true' === a;
                else if (d.TYPEREF.test(a)) c = a;
                else
                    throw Error(
                        'Illegal option value in message ' +
                            f.name +
                            ', option ' +
                            b +
                            ' at line ' +
                ...
                if (a !== d.END)
                    throw Error(
                        'Illegal end of option in message ' +
                            f.name +
                            ', option ' +
                            b +
                            ' at line ' +
            ...
            b._parseService = function(f, a) {
                ...
                if (!d.NAME.test(a))
                    throw Error(
                        'Illegal service name at line ' +
                            this.tn.line +
                            ': ' +
                            a
                    );
                var c = a,
                    b = { name: c, rpc: {}, options: {} };
                a = this.tn.next();
                if (a !== d.OPEN)
                    throw Error(
                        'Illegal start of service ' +
                            c +
                            ' at line ' +
                            this.tn.line +
                            ': ' +
                ...
                do
                    ...
                    else if ('rpc' === a) this._parseServiceRPC(b, a);
                    else if (a !== d.CLOSE)
                        throw Error(
                            'Illegal type of service ' +
                                c +
                                ' at line ' +
                                this.tn.line +
                                ': ' +
            ...
            b._parseServiceRPC = function(f, a) {
                ...
                if (!d.NAME.test(a))
                    throw Error(
                        'Illegal method name in service ' +
                            f.name +
                            ' at line ' +
                            this.tn.line +
                            ': ' +
                ...
                var b = a,
                    e = { request: null, response: null, options: {} };
                a = this.tn.next();
                if (a !== d.COPTOPEN)
                    throw Error(
                        'Illegal start of request type in service ' +
                            f.name +
                            '#' +
                            b +
                            ' at line ' +
                ...
                if (!d.TYPEREF.test(a))
                    throw Error(
                        'Illegal request type in service ' +
                            f.name +
                            '#' +
                            b +
                            ' at line ' +
                ...
                if (a != d.COPTCLOSE)
                    throw Error(
                        'Illegal end of request type in service ' +
                            f.name +
                            '#' +
                            b +
                            ' at line ' +
                ...
                if (a != d.COPTOPEN)
                    throw Error(
                        'Illegal start of response type in service ' +
                            f.name +
                            '#' +
                            b +
                            ' at line ' +
                ...
                if (a !== d.COPTCLOSE)
                    throw Error(
                        'Illegal end of response type in service ' +
                            f.name +
                            '#' +
                            b +
                            ' at line ' +
                ...
                if (a === d.OPEN) {
                    do
                        if (((a = this.tn.next()), 'option' === a))
                            ...
                            throw Error(
                                'Illegal start of option inservice ' +
                                    f.name +
                                    '#' +
                                    b +
                                    ' at line ' +
            ...
            b._parseMessage = function(f, a, c) {
                ...
                if (e) {
                    ...
                    if (c !== d.EQUAL)
                        throw Error(
                            'Illegal id assignment after group ' +
                                b.name +
                                ' at line ' +
                                this.tn.line +
                                ': ' +
                    ...
                    try {
                        ...
                        throw Error(
                            'Illegal field id value for group ' +
                                b.name +
                                '#' +
                                a.name +
                                ' at line ' +
                ...
                c === d.OPTOPEN &&
                    a &&
                    (this._parseFieldOptions(b, a, c), (c = this.tn.next()));
                if (c !== d.OPEN)
                    throw Error(
                        'Illegal start of ' +
                            (e ? 'group' : 'message') +
                ...
                do
                    if (((c = this.tn.next()), c === d.CLOSE)) {
                        ...
                        break;
                    } else if (d.RULE.test(c)) this._parseMessageField(b, c);
                    else if ('oneof' === c) this._parseMessageOneOf(b, c);
                    else if ('enum' === c) this._parseEnum(b, c);
                    else if ('message' === c) this._parseMessage(b, null, c);
                    else if ('option' === c) this._parseOption(b, c);
                    else if ('extensions' === c)
                        b.extensions = this._parseExtensions(b, c);
                    else if ('extend' === c) this._parseExtend(b, c);
                    else
                        throw Error(
                            'Illegal token in message ' +
                                b.name +
                                ' at line ' +
                                this.tn.line +
                                ': ' +
            ...
            b._parseMessageField = function(b, a) {
                ...
                if ('group' === a) {
                    ...
                    a = this.tn.next();
                    a === d.OPTOPEN &&
                        (this._parseFieldOptions(b, c, a),
                        (a = this.tn.next()));
                    if (a !== d.END)
                        throw Error(
                            'Illegal delimiter in message ' +
                                b.name +
                                '#' +
                                c.name +
                                ' at line ' +
            ...
            b._parseMessageOneOf = function(b, a) {
                ...
                for (; this.tn.peek() !== d.CLOSE; )
                    (e = this._parseMessageField(b, 'optional')),
                        (e.oneof = c),
                        g.push(e.id);
                this.tn.next();
                b.oneofs[c] = g;
            ...
            b._parseFieldOptions = function(b, a, c) {
                ...
                do {
                    c = this.tn.next();
                    if (c === d.OPTCLOSE) break;
                    else if (c === d.OPTEND) {
                        if (e)
                            throw Error(
                                'Illegal start of options in message ' +
                                    b.name +
                                    '#' +
                                    a.name +
                                    ' at line ' +
            ...
            b._parseFieldOption = function(b, a, c) {
                ...
                else if (d.TYPEREF.test(c)) b = this.tn.next();
                else
                    throw Error(
                        'Illegal value in message ' +
                            b.name +
                            '#' +
                            a.name +
                            ', option ' +
            ...
            b._parseEnumValue = function(b, a) {
                ...
                a = this.tn.next();
                a === d.OPTOPEN &&
                    (this._parseFieldOptions(b, { options: {} }, a),
                    (a = this.tn.next()));
                if (a !== d.END)
                    throw Error(
                        'Illegal delimiter in enum ' +
                            b.name +
                            ' at line ' +
                            this.tn.line +
                            ': ' +
            ...
            b._parseExtensions = function(b, a) {
                ...
                'min' === a
                    ...
                    : 'max' === a
                    ? c.push(e.ID_MAX)
                    : c.push(this._parseNumber(a));
                a = this.tn.next();
                if ('to' !== a)
                    throw Error(
                        'Illegal extensions delimiter in message ' +
                            b.name +
                            ' at line ' +
                            this.tn.line +
                            ': ' +
            ...
            b._parseExtend = function(b, a) {
                ...
                do
                    if (((a = this.tn.next()), a === d.CLOSE)) {
                        ...
                        a == d.END && this.tn.next();
                        break;
                    } else if (d.RULE.test(a)) this._parseMessageField(c, a);
                    else
                        throw Error(
                            'Illegal token in extend ' +
                                c.name +
                                ' at line ' +
                                this.tn.line +
                                ': ' +
        ...
        g.Reflect = (function(e) {
            function d(a, b) {
                ...
                switch (f) {
                    ...
                    default:
                        throw Error(
                            'Illegal wire type in unknown group ' + a + ': ' + f
                        );
                }
                return !0;
            }
            function g(a, b) {
                if (
                    a &&
                    'number' === typeof a.low &&
                    'number' === typeof a.high &&
                    'boolean' === typeof a.unsigned &&
                    a.low === a.low &&
                    a.high === a.high
                )
                    return new e.Long(
                        a.low,
                        a.high,
                        'undefined' === typeof b ? a.unsigned : b
                    );
                if ('string' === typeof a)
            ...
            b.addChild = function(b) {
                ...
                if ((c = this.getChild(b.name)))
                    if (
                        c instanceof a.Field &&
                        c.name !== c.originalName &&
                        null === this.getChild(c.originalName)
                    )
                        c.name = c.originalName;
                    else if (
                        b instanceof a.Field &&
                        b.name !== b.originalName &&
                        null === this.getChild(b.originalName)
                    )
                        b.name = b.originalName;
                    else
                        throw Error(
            ...
            b.resolve = function(a, b) {
                ...
                do {
                    do {
                        ...
                        if (
                            !(e && e instanceof k.T) ||
                            (b && e instanceof k.Message.Field)
                        ) {
                            e = null;
                            break;
                        }
            ...
            b.build = function() {
                for (
                    var a = {}, b = this.children, c = 0, e = b.length, d;
                    c < e;
                    ++c
                )
            ...
            c.build = function(b) {
                ...
                b = (function(a, b) {
                    ...
                    var e = b.getChildren(a.Reflect.Message.Field),
                        l = b.getChildren(a.Reflect.Message.OneOf),
                        f = function(b, c) {
                            ...
                            for (f = e.length; d < f; ++d) {
                                ...
                                q.required &&
                                    null !== q.defaultValue &&
                                    (this[q.name] = q.defaultValue);
                            }
                            if (0 < arguments.length)
                                if (
                                    1 !== arguments.length ||
                                    'object' !== typeof b ||
                                    'function' === typeof b.encode ||
                                    a.Util.isArray(b) ||
                                    b instanceof m ||
                                    ...
                                    for (
                                        q = Object.keys(b), d = 0, f = q.length;
                                        d < f;
                                        ++d
                                    )
                                        this.$set(q[d], b[q[d]]);
                        },
                        d = (f.prototype = Object.create(
                            a.Builder.Message.prototype
                        ));
                    d.add = function(c, e, d) {
                        ...
                        if (!d) {
                            ...
                            if (!l.repeated)
                                throw Error(
                                    this + '#' + c + ' is not a repeated field'
                                );
                        }
                    ...
                    d.set = function(c, e, d) {
                        ...
                        l.oneof &&
                            (null !== e
                                ? (null !== this[l.oneof.name] &&
                                      (this[this[l.oneof.name]] = null),
                                  (this[l.oneof.name] = l.name))
                                : l.oneof.name === c &&
                                  (this[l.oneof.name] = null));
                        return this;
                    };
                    d.$set = d.set;
                    d.get = function(c, l) {
                        ...
                        if (!(e && e instanceof a.Reflect.Message.Field))
                            throw Error(
                                this + '#' + c + ' is not a field: undefined'
                            );
                    ...
                    for (var q = 0; q < e.length; q++) {
                        var g = e[q];
                        g instanceof a.Reflect.Message.ExtensionField ||
                            (b.builder.options.populateAccessors &&
                                (function(a) {
                                    var c = a.originalName.replace(
                                            /(_[a-zA-Z])/g,
                                            function(a) {
                                                return a
                                                    .toUpperCase()
                                    ...
                                    null === b.getChild('set' + c) &&
                                        (d['set' + c] = e);
                                    null === b.getChild('set_' + l) &&
                                        (d['set_' + l] = e);
                                    null === b.getChild('get' + c) &&
                                        (d['get' + c] = f);
                                    null === b.getChild('get_' + l) &&
                                        (d['get_' + l] = f);
                                })(g));
                    }
                    ...
                    f.decodeDelimited = function(a, c) {
                        ...
                        var l = a.offset,
                            e = a.readVarint32();
                        if (a.remaining() < e) return (a.offset = l), null;
                        try {
                            var d = b.decode(
                                a.slice(a.offset, a.offset + e).LE()
                            );
                            a.offset += e;
                            return d;
                        } catch (f) {
                ...
                for (var c = 0, f = this.children.length, d; c < f; c++)
                    if (((d = this.children[c]), d instanceof p))
                        b[d.name] = d.build();
                    else if (d instanceof a) b[d.name] = d.build();
                        ...
                        throw Error(
                            'Illegal reflect child of ' +
                                this.toString(!0) +
                                ': ' +
                                children[c].toString(!0)
                        );
                return (this.clazz = b);
            };
            c.encode = function(a, b, c) {
                for (
                    var e = null, d, f = 0, g = this._fields.length, h;
                    f < g;
                    ++f
                )
                    (d = this._fields[f]),
                        ...
                        d.required && null === h
                            ? null === e && (e = d)
                            : d.encode(c ? h : d.verifyValue(h), b);
                if (null !== e)
                    throw ((a = Error(
            ...
            c.calculate = function(a) {
                for (
                    var b = 0, c = 0, e = this._fields.length, d, f;
                    c < e;
                    ++c
                ) {
                    d = this._fields[c];
            ...
            c.decode = function(a, b, c) {
                ...
                for (
                    var f = a.offset, g = new this.clazz(), h, p, k;
                    a.offset < f + b || (-1 === b && 0 < a.remaining());
                        ...
                        if (k !== c)
                            throw Error(
                                'Illegal group end indicator for ' +
                                    ...
                                    k +
                                    ' (' +
                                    (c ? c + ' expected' : 'not a group') +
                                    ')'
                            );
                        break;
                    }
                    if ((h = this._fieldsById[k]))
                        h.repeated && !h.options.packed
                            ? g[h.name].push(h.decode(p, a))
                            : ((g[h.name] = h.decode(p, a)),
                              h.oneof &&
                                  (null !== this[h.oneof.name] &&
                                      (this[this[h.oneof.name]] = null),
                                  (g[h.oneof.name] = h.name)));
                    else
                        switch (p) {
                            case e.WIRE_TYPES.VARINT:
                                a.readVarint32();
            ...
            var r = function(b, c, e, d, f, g, h, p) {
                ...
                !this.builder.options.convertFieldsToCamelCase ||
                    this instanceof a.ExtensionField ||
                    (this.name = r._toCamelCase(this.name));
            };
            ...
            c.build = function() {
                this.defaultValue =
                    'undefined' !== typeof this.options['default']
                ...
                switch (this.type) {
                    ...
                    case e.TYPES['enum']:
                        ...
                        for (d = 0; d < k.length; d++)
                            if (k[d].name == a || k[d].id == a) return k[d].id;
                        c(a, 'not a valid enum value');
                    case e.TYPES.group:
                    case e.TYPES.message:
                        (a && 'object' === typeof a) ||
                            c(typeof a, 'object expected');
                ...
                try {
                    if (this.repeated) {
                        ...
                        if (
                            this.options.packed &&
                            0 <=
                                e.PACKABLE_WIRE_TYPES.indexOf(
                                    this.type.wireType
                                )
                        ) {
                            b.writeVarint32(
                                (this.id << 3) | e.WIRE_TYPES.LDELIM
                            );
                        ...
                        b.writeVarint32((this.id << 3) | this.type.wireType),
                            this.encodeValue(a, b);
                } catch (k) {
                    throw Error(
                        'Illegal value for ' +
                            this.toString(!0) +
            ...
            c.encodeValue = function(a, b) {
                ...
                switch (this.type) {
                    ...
                    case e.TYPES.bool:
                        'string' === typeof a
                            ? b.writeVarint32(
                                  'false' === a.toLowerCase() ? 0 : !!a
                              )
                            : b.writeVarint32(a ? 1 : 0);
                        break;
                    case e.TYPES['enum']:
                        b.writeVarint32(a);
                        break;
                        ...
                        if (
                            ...
                            for (c = 0; c < a.length; c++)
                                (b += m.calculateVarint32(
                                    ...
                                    (b += this.calculateValue(a[c]));
                    } else
                        (b += m.calculateVarint32(
                            (this.id << 3) | this.type.wireType
                        )),
                            (b += this.calculateValue(a));
                } catch (f) {
                    throw Error(
                        'Illegal value for ' +
                            this.toString(!0) +
            ...
            c.calculateValue = function(a) {
                ...
                switch (this.type) {
                    case e.TYPES.int32:
                        return 0 > a
                            ? m.calculateVarint64(a)
                            : m.calculateVarint32(a);
                    case e.TYPES.uint32:
                    ...
                    case e.TYPES.string:
                        return (
                            (a = m.calculateUTF8Bytes(a)),
                            m.calculateVarint32(a) + a
                        );
                    case e.TYPES.bytes:
                        if (0 > a.remaining())
                            throw Error(
                        ...
                        return (
                            m.calculateVarint32(a.remaining()) + a.remaining()
                        );
                    case e.TYPES.message:
                        return (
                            (a = this.resolvedType.calculate(a)),
                            m.calculateVarint32(a) + a
                        );
                    case e.TYPES.group:
                        return (
                            ...
                            a +
                                m.calculateVarint32(
                                    (this.id << 3) | e.WIRE_TYPES.ENDGROUP
                                )
                        );
                }
                throw Error(
            ...
            c.decode = function(a, b, c) {
                if (
                    a != this.type.wireType &&
                    (c || a != e.WIRE_TYPES.LDELIM || !this.repeated)
                )
                    throw Error(
                ...
                switch (this.type) {
                    ...
                    case e.TYPES.message:
                        return (
                            (a = b.readVarint32()),
                            this.resolvedType.decode(b, a)
                        );
                    case e.TYPES.group:
                        return this.resolvedType.decode(b, -1, this.id);
                }
                throw Error(
                    '[INTERNAL] Illegal wire type for ' +
                        this.toString(!0) +
                        ': ' +
                        a
                );
                ...
                return this.clazz && !a
                    ...
                    : (this.clazz = (function(a, b) {
                          var c = function(b) {
                              ...
                              d = (c.prototype = Object.create(
                                  a.Builder.Service.prototype
                              ));
                          Object.defineProperty &&
                                          ...
                                          c instanceof
                                              ...
                                              ? this.rpcImpl(
                                                    ...
                                                    function(c, e) {
                                                        if (c) d(c);
                                                            ...
                                                            try {
                                                                e = a.resolvedResponseType.clazz.decode(
                                                                    e
                                                                );
                                                            } catch (f) {}
                                                            e &&
                                              ...
                                              : setTimeout(
                                                    d.bind(
                                                        this,
                                                        Error(
                                                            'Illegal request type provided to service method ' +
                                                                b.name +
                                                                '#' +
                                                                a.name
                                                        )
        ...
        g.Builder = (function(e, d, g) {
            ...
            n.define = function(b, e) {
                ...
                for (c = 0; c < a.length; c++)
                    null === this.ptr.getChild(a[c]) &&
                        this.ptr.addChild(
                            new g.Namespace(this, this.ptr, a[c], e)
                        ),
                        (this.ptr = this.ptr.getChild(a[c]));
                return this;
            };
            k.isValidMessage = function(b) {
                ...
                if ('undefined' !== typeof b.enums) {
                    ...
                    for (f = 0; f < b.enums.length; f++)
                        if (!k.isValidEnum(b.enums[f])) return !1;
                }
                if ('undefined' !== typeof b.messages) {
                    if (!e.Util.isArray(b.messages)) return !1;
                    for (f = 0; f < b.messages.length; f++)
                        if (
                            !k.isValidMessage(b.messages[f]) &&
                            !k.isValidExtend(b.messages[f])
                        )
                            return !1;
                }
                return 'undefined' === typeof b.extensions ||
                    (e.Util.isArray(b.extensions) &&
                        2 === b.extensions.length &&
                        'number' === typeof b.extensions[0] &&
                        'number' === typeof b.extensions[1])
                    ? !0
                    : !1;
            };
            k.isValidMessageField = function(b) {
                if (
                    'string' !== typeof b.rule ||
                    'string' !== typeof b.name ||
                ...
                if ('undefined' !== typeof b.options) {
                    ...
                    for (
                        var e = Object.keys(b.options), a = 0, c;
                        a < e.length;
                        a++
                    )
                        if (
                            'string' !== typeof (c = e[a]) ||
                            ('string' !== typeof b.options[c] &&
                                'number' !== typeof b.options[c] &&
                                'boolean' !== typeof b.options[c])
                        )
                            return !1;
                }
                return !0;
            ...
            k.isValidEnum = function(b) {
                if (
                    ...
                    !d.NAME.test(b.name) ||
                    'undefined' === typeof b.values ||
                    !e.Util.isArray(b.values) ||
                    0 == b.values.length
                )
                    return !1;
                for (var f = 0; f < b.values.length; f++)
                    if (
                        'object' != typeof b.values[f] ||
                        'string' !== typeof b.values[f].name ||
                        'undefined' === typeof b.values[f].id ||
                        !d.NAME.test(b.values[f].name) ||
                        !d.NEGID.test('' + b.values[f].id)
                    )
                        return !1;
                return !0;
            };
            n.create = function(b) {
                ...
                for (d.push(b); 0 < d.length; ) {
                    ...
                    if (e.Util.isArray(b))
                            ...
                            if (k.isValidMessage(a)) {
                                ...
                                if (a.fields && 0 < a.fields.length)
                                    for (
                                        ...
                                        if (p.options)
                                            for (
                                                ...
                                                if ('string' !== typeof l[q])
                                                    throw Error(
                                                        'Illegal field option name in message ' +
                                                            c.name +
                                                            '#' +
                                                            p.name +
                                                            ': ' +
                                                ...
                                                if (
                                                    ...
                                                    'boolean' !==
                                                        typeof p.options[l[q]]
                                                )
                                                    throw Error(
                                                        'Illegal field option value in message ' +
                                                            c.name +
                                                            '#' +
                                                            p.name +
                                                            '#' +
                                        ...
                                        l = null;
                                        if (
                                            'string' === typeof p.oneof &&
                                            ((l = n[p.oneof]),
                                            'undefined' === typeof l)
                                        )
                                            throw Error(
                                                'Illegal oneof in message ' +
                                                    c.name +
                                                    '#' +
                                                    p.name +
                                                    ': ' +
                                ...
                                if (a.messages && 0 < a.messages.length)
                                    for (h = 0; h < a.messages.length; h++)
                                        n.push(a.messages[h]);
                                a.extensions &&
                                    ((c.extensions = a.extensions),
                                    c.extensions[0] < e.ID_MIN &&
                                        (c.extensions[0] = e.ID_MIN),
                                    c.extensions[1] > e.ID_MAX &&
                                        (c.extensions[1] = e.ID_MAX));
                                this.ptr.addChild(c);
                                0 < n.length &&
                                    (d.push(b), (b = n), (this.ptr = c));
                                ...
                                for (h in a.rpc)
                                    a.rpc.hasOwnProperty(h) &&
                                        c.addChild(
                                            new g.Service.RPCMethod(
                                                this,
                                                c,
                                                h,
                                                a.rpc[h].request,
                                ...
                                if ((c = this.ptr.resolve(a.ref)))
                                    for (h = 0; h < a.fields.length; h++) {
                                        if (null !== c.getChild(a.fields[h].id))
                                            throw Error(
                                                'Duplicate extended field id in message ' +
                                                    c.name +
                                                    ': ' +
                                                    a.fields[h].id
                                            );
                                        if (
                                            a.fields[h].id < c.extensions[0] ||
                                            a.fields[h].id > c.extensions[1]
                                        )
                                            throw Error(
                                                'Illegal extended field id in message ' +
                                                    c.name +
                                                    ': ' +
                                                    a.fields[h].id +
                                                    ' (' +
                                                    c.extensions.join(' to ') +
                                                    ' expected)'
                                            );
                                        n = a.fields[h].name;
                                        this.options.convertFieldsToCamelCase &&
                                            (n = g.Message.Field._toCamelCase(
                                                a.fields[h].name
                                            ));
                                        p = new g.Message.ExtensionField(
                                            this,
                                            c,
                                            a.fields[h].rule,
                                            a.fields[h].type,
                        ...
                        throw Error(
                            'Not a valid namespace: ' + JSON.stringify(b)
                        );
            ...
            n['import'] = function(b, d) {
                ...
                if (b.imports && 0 < b.imports.length) {
                    ...
                    if ('object' === typeof d) {
                        if (
                            ((this.importRoot = d.root),
                            (g = !0),
                            (a = this.importRoot),
                            (d = d.file),
                            0 <= a.indexOf('\\') || 0 <= d.indexOf('\\'))
                        )
                            c = '\\';
                    } else
                        'string' === typeof d
                    ...
                    for (var k = 0; k < b.imports.length; k++)
                        if ('string' === typeof b.imports[k]) {
                            if (!a)
                                throw Error(
                                    'Cannot determine import root: File name is unknown'
                                );
                            var h = b.imports[k];
                            if (
                                !/^google\/protobuf\//.test(h) &&
                                ((h = a + c + h), !0 !== this.files[h])
                            ) {
                                /\.proto$/i.test(h) &&
                                    !e.DotProto &&
                                    (h = h.replace(/\.proto$/, '.json'));
                ...
                b.messages &&
                    (b['package'] && this.define(b['package'], b.options),
                    this.create(b.messages),
                    this.reset());
                b.enums &&
                    (b['package'] && this.define(b['package'], b.options),
                    this.create(b.enums),
                ...
                if (null != this.ptr && 'object' !== typeof this.ptr.type) {
                    if (this.ptr instanceof g.Namespace) {
                        ...
                        if (d.TYPE.test(this.ptr.type))
                            ...
                            b = (this.ptr instanceof g.Message.ExtensionField
                        ...
                        if (this.ptr instanceof e.Reflect.Service.Method)
                            if (
                                this.ptr instanceof e.Reflect.Service.RPCMethod
                            ) {
                                b = this.ptr.parent.resolve(
        ...
        g.loadProto = function(e, d, m) {
            if (
                'string' === typeof d ||
                (d && 'string' === typeof d.file && 'string' === typeof d.root)
            )
                (m = d), (d = void 0);
            return g.loadJson(new g.DotProto.Parser(e).parse(), d, m);
        };
        g.protoFromString = g.loadProto;
        g.loadProtoFile = function(e, d, m) {
            d && 'object' === typeof d
                ? ((m = d), (d = null))
                : (d && 'function' === typeof d) || (d = null);
            if (d)
                return g.Util.fetch(
                    'string' === typeof e ? e : e.root + '/' + e.file,
                    function(k) {
                        if (null === k) d(Error('Failed to fetch file'));
                        else
                            try {
                                d(null, g.loadProto(k, m, e));
                            } catch (b) {
                                d(b);
                            }
                    }
            ...
            return null === k ? null : g.loadProto(k, m, e);
        };
        ...
        g.newBuilder = function(e) {
            ...
            'undefined' === typeof e.populateAccessors &&
                (e.populateAccessors = g.populateAccessors);
    ...
    'undefined' !== typeof module && module.exports
        ? (module.exports = u(require('bytebuffer')))
