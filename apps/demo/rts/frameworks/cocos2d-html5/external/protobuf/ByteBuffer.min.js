...
(function(s) {
    function u(k) {
        ...
        function t() {
            ...
            return function() {
                ...
                1024 < a.length + arguments.length &&
                    (b.push(u.apply(String, a)), (a.length = 0));
        ...
        g.concat = function(a, b, c, d) {
            ...
            for (n = 0; n < h; )
                (c = a[n++]),
                    ...
                    0 >= e ||
                        (d.set(
                            new Uint8Array(c.buffer).subarray(
                                c.offset,
                                c.limit
                            ),
                            b.offset
        ...
        g.wrap = function(a, b, c, d) {
            ...
            if (a instanceof Uint8Array)
                (b = new g(0, c, d)),
                    0 < a.length &&
                        ((b.buffer = a.buffer),
                        (b.offset = a.byteOffset),
                        (b.limit = a.byteOffset + a.length),
                        (b.view =
                            0 < a.length ? new DataView(a.buffer) : null));
            else if (a instanceof ArrayBuffer)
                (b = new g(0, c, d)),
                    0 < a.byteLength &&
                        ((b.buffer = a),
                        (b.offset = 0),
                        (b.limit = a.byteLength),
                        (b.view = 0 < a.byteLength ? new DataView(a) : null));
            else if ('[object Array]' === Object.prototype.toString.call(a))
                for (
                    b = new g(a.length, c, d), b.limit = a.length, i = 0;
                    i < a.length;
                    ++i
                )
        ...
        e.writeInt8 = function(a, b) {
            ...
            if (!this.noAssert) {
                if ('number' !== typeof a || 0 !== a % 1)
                    throw TypeError(
                        'Illegal value: ' + a + ' (not an integer)'
                    );
                a |= 0;
                if ('number' !== typeof b || 0 !== b % 1)
                    throw TypeError(
                        'Illegal offset: ' + b + ' (not an integer)'
                    );
                b >>>= 0;
        ...
        e.readInt8 = function(a) {
            ...
            if (!this.noAssert) {
                if ('number' !== typeof a || 0 !== a % 1)
                    throw TypeError(
                        'Illegal offset: ' + a + ' (not an integer)'
                    );
                a >>>= 0;
            ...
            ((e.writeInt64 = function(a, b) {
                ...
                if (!this.noAssert) {
                    if ('number' === typeof a) a = k.fromNumber(a);
                        ...
                        throw TypeError(
                            'Illegal value: ' + a + ' (not an integer or Long)'
                        );
                    if ('number' !== typeof b || 0 !== b % 1)
                        throw TypeError(
                            'Illegal offset: ' + b + ' (not an integer)'
                ...
                b -= 8;
                this.littleEndian
                    ? (this.view.setInt32(b, a.low, !0),
                      this.view.setInt32(b + 4, a.high, !0))
                    : (this.view.setInt32(b, a.high, !1),
                      this.view.setInt32(b + 4, a.low, !1));
                c && (this.offset += 8);
                return this;
            }),
            (e.writeLong = e.writeInt64),
            (e.readInt64 = function(a) {
                var b = 'undefined' === typeof a;
                b && (a = this.offset);
                if (!this.noAssert) {
                    if ('number' !== typeof a || 0 !== a % 1)
                ...
                a = this.littleEndian
                    ? new k(
                          this.view.getInt32(a, !0),
                          this.view.getInt32(a + 4, !0),
                          !1
                      )
                    : new k(
                          this.view.getInt32(a + 4, !1),
                          this.view.getInt32(a, !1),
                          !1
                      );
                b && (this.offset += 8);
                return a;
            }),
            (e.readLong = e.readInt64),
            (e.writeUint64 = function(a, b) {
                var c = 'undefined' === typeof b;
                c && (b = this.offset);
                if (!this.noAssert) {
                    if ('number' === typeof a) a = k.fromNumber(a);
        ...
        e.writeVarint32 = function(a, b) {
            ...
            128 <= a
                ? ((d = (a >> 7) | 128),
                  this.view.setUint8(b + 1, d),
                  16384 <= a
                      ? ((d = (a >> 14) | 128),
                        this.view.setUint8(b + 2, d),
                        2097152 <= a
                            ? ((d = (a >> 21) | 128),
                              this.view.setUint8(b + 3, d),
                              268435456 <= a
                                  ? (this.view.setUint8(b + 4, (a >> 28) & 15),
                                    (d = 5))
                                  : (this.view.setUint8(b + 3, d & 127),
                                    (d = 4)))
                            : (this.view.setUint8(b + 2, d & 127), (d = 3)))
                      : (this.view.setUint8(b + 1, d & 127), (d = 2)))
                : (this.view.setUint8(b, d & 127), (d = 1));
        ...
        e.readVarint32ZigZag = function(a) {
            ...
            'object' === typeof a
                ? (a.value = g.zigZagDecode32(a.value))
                : (a = g.zigZagDecode32(a));
            return a;
        };
        k &&
            ...
            (e.writeVarint64 = function(a, b) {
                ...
                switch (d) {
                    ...
                    case 8:
                        this.view.setUint8(
                            b + 7,
                            8 !== d ? (n >>> 21) | 128 : (n >>> 21) & 127
                        );
                    case 7:
                        this.view.setUint8(
                            b + 6,
                            7 !== d ? (n >>> 14) | 128 : (n >>> 14) & 127
                        );
                    case 6:
                        this.view.setUint8(
                            b + 5,
                    ...
                    case 4:
                        this.view.setUint8(
                            b + 3,
                            4 !== d ? (f >>> 21) | 128 : (f >>> 21) & 127
                        );
                    case 3:
                        this.view.setUint8(
                            b + 2,
                            3 !== d ? (f >>> 14) | 128 : (f >>> 14) & 127
                        );
                    case 2:
                        this.view.setUint8(
                            b + 1,
            ...
            (e.readVarint64ZigZag = function(a) {
                (a = this.readVarint64(a)) && a.value instanceof k
                    ? (a.value = g.zigZagDecode64(a.value))
                    : (a = g.zigZagDecode64(a));
                return a;
            }));
        ...
        e.writeIString = function(a, b) {
            ...
            if (b !== d + 4 + f)
                throw RangeError(
                    'Illegal range: Truncated data, ' + b + ' == ' + (b + 4 + f)
                );
        ...
        e.readUTF8String = function(a, b, c) {
            ...
            if (!this.noAssert) {
                if ('number' !== typeof a || 0 !== a % 1)
                    throw TypeError(
                        'Illegal length: ' + a + ' (not an integer)'
                    );
                a |= 0;
                if ('number' !== typeof c || 0 !== c % 1)
                    throw TypeError(
                        'Illegal offset: ' + c + ' (not an integer)'
                    );
                c >>>= 0;
            ...
            if (b === g.METRICS_CHARS) {
                ...
                l.g(
                    function() {
                        return f < a && c < this.limit
                            ? this.view.getUint8(c++)
                            : null;
                    }.bind(this),
                    function(a) {
                        ++f;
                ...
                if (f !== a)
                    throw RangeError(
                        'Illegal range: Truncated data, ' + f + ' == ' + a
                    );
                return d
                    ? ((this.offset = c), h())
                    : { string: h(), length: c - e };
            ...
            if (b === g.METRICS_BYTES) {
                ...
                if (c !== r)
                    throw RangeError(
                        'Illegal range: Truncated data, ' + c + ' == ' + r
                    );
                return d
                    ? ((this.offset = c), h())
                    : { string: h(), length: c - e };
        ...
        e.writeVString = function(a, b) {
            ...
            if (b !== d + f + e)
                throw RangeError(
                    'Illegal range: Truncated data, ' + b + ' == ' + (b + f + e)
                );
            return c ? ((this.offset = b), this) : b - d;
        };
        ...
        e.append = function(a, b, c) {
            ...
            new Uint8Array(this.buffer, c - b).set(
                new Uint8Array(a.buffer).subarray(a.offset, a.limit)
            );
            a.offset += b;
            d && (this.offset += b);
            return this;
        ...
        e.clone = function(a) {
            ...
            a
                ? ((a = new ArrayBuffer(this.buffer.byteLength)),
                  new Uint8Array(a).set(this.buffer),
                  (b.buffer = a),
                  (b.view = new DataView(a)))
        ...
        e.copyTo = function(a, b, c, d) {
            ...
            new Uint8Array(a.buffer).set(
                new Uint8Array(this.buffer).subarray(c, d),
                b
            );
            f && (this.offset += h);
            e && (a.offset += h);
        ...
        e.resize = function(a) {
            if (!this.noAssert) {
                if ('number' !== typeof a || 0 !== a % 1)
                    throw TypeError(
                        'Illegal capacity: ' + a + ' (not an integer)'
                    );
                a |= 0;
                if (0 > a) throw RangeError('Illegal capacity: 0 <= ' + a);
            }
            this.buffer.byteLength < a &&
                ((a = new ArrayBuffer(a)),
                new Uint8Array(a).set(new Uint8Array(this.buffer)),
                (this.buffer = a),
        ...
        e.reverse = function(a, b) {
            ...
            Array.prototype.reverse.call(
                new Uint8Array(this.buffer).subarray(a, b)
            );
        ...
        e.toBuffer = function(a) {
            ...
            new Uint8Array(a).set(
                new Uint8Array(this.buffer).subarray(b, c),
                0
            );
            return a;
        };
        ...
        var v = (function() {
            ...
            a.h = function(a, b) {
                ...
                for (var f, e, g; null !== (f = a()); )
                    if (
                        ((e = c[f]),
                        'undefined' === typeof e && d(f),
                        null !== (f = a()) &&
                            ((g = c[f]),
                            'undefined' === typeof g && d(f),
                            b(((e << 2) >>> 0) | ((g & 48) >> 4)),
                            null !== (f = a())))
                    ) {
                        e = c[f];
        ...
        e.toDebug = function(a) {
            for (
                ...
                -1 !== b &&
                    ((d = this.view.getUint8(b)),
                    (f =
                        16 > d
                            ? f + ('0' + d.toString(16).toUpperCase())
                            : f + d.toString(16).toUpperCase()),
                    a &&
                        (e +=
                            32 < d && 127 > d ? String.fromCharCode(d) : '.'));
                ++b;
                if (a && 0 < b && 0 === b % 16 && b !== c) {
                    for (; 51 > f.length; ) f += ' ';
                    g += f + e + '\n';
        ...
        g.fromDebug = function(a, b, c) {
            ...
            b = new g(((d + 1) / 3) | 0, b, c);
            for (
                var f = 0, e = 0, h, k = !1, l = !1, m = !1, q = !1, p = !1;
                f < d;
        ...
        e.toHex = function(a, b) {
            ...
            for (var c = Array(b - a), d; a < b; )
                (d = this.view.getUint8(a++)),
                    16 > d
                        ? c.push('0', d.toString(16))
        ...
        e.toUTF8 = function(a, b) {
            ...
            try {
                ...
                if (a !== b)
                    throw RangeError(
                        'Illegal range: Truncated data, ' + a + ' != ' + b
                    );
            }
            return c();
        };
    ...
    'undefined' !== typeof module && module.exports
        ? (module.exports = u(require('long')))
        : 'function' === typeof define && define.amd
        ? define('ByteBuffer', ['Long'], function(k) {
              return u(k);
          })
